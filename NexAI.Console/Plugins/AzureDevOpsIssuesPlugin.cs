...
public class AzureDevOpsIssuesPlugin(Options options)
{
    ...
    public async Task<AzureDevOpsWorkItem[]> FindAzureDevOpsWorkItemsByPhrase(string phrase, int limit)
    {
        ...
        return await new GetAzureDevopsWorkItemsQuery(options).Handle(phrase, limit);
    }
    ...
    public async Task<AzureDevOpsWorkItem[]> GetAzureDevOpsWorkItemsRelatedToZendeskTicket(string zendeskTicketId, int limit)
    {
        ...
        return await new GetAzureDevopsWorkItemsRelatedToZendeskTicketQuery(options).Handle(zendeskTicketId, limit);
    }
}
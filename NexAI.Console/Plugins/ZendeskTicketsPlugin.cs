    ...
    FindZendeskTicketsThatContainPhraseQuery findZendeskTicketsThatContainPhraseQuery)
{
    ...
    public async Task<ZendeskTicket?> GetTicketByExternalId(string externalId, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<ZendeskTicket[]> GetTicketsByExternalIds(string[] externalIds, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<SearchResult[]> FindSimilarTicketsByPhrase(string phrase, int limit, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<SearchResult[]> FindZendeskTicketsByPhrase(string phrase, int limit, CancellationToken cancellationToken = default)
    {
